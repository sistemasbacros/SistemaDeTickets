...
?>
  ...
  <button class="btn btn-default1" id="EX" name='EX' onclick="ExportToExcel('xlsx')"> <img src="EXCEL.PNG" width="50" /> </button> 
   ...
   <button class="btn btn-default1" id="sincro" name='sincro' onclick="theFunction14();"> <img src="SubirArcchivos.png" width="100" /> </button>  
...
<div class="inner1"> <table id="example" class="table table-striped table-bordered" width="100%"  style="font-size:100%;background-color:#2D6DA6;color:white;font-weight: bold;"></table> </div></div>
...
new DataTable('#example', {
    ...
    data: dataSet, scrollY: 450,scrollX: 1,
  scrollCollapse: true
});
