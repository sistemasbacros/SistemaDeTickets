...
for (var i = 0; i < darray1.length; i++) {
	dataSet.push([darray1[i],darray2[i],darray3[i],darray4[i],darray5[i],darray6[i],formatter.format(darray7[i]),'<a href="<?php echo COMEDOR_URL; ?>/Comedor/uploads/'+darray3[i]+'/OPERACIONES/">'+darray3[i]+'</a>'])
}
